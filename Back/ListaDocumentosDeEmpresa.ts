      ...
      "output": [
        {
          ...
          "to": [
            {
              "id": "187e8a94-17b7-4e82-bfd6-8a1aac6b31d3",
      ...
      "output": [
        {
          ...
          "to": [
            {
              "id": "68405554-eab6-49ec-b043-510021c5e67b",
      ...
      "output": [
        {
          ...
          "to": [
            {
              "id": "afed8e27-7255-410c-939c-17707836ed9a",
        ...
        },
        {
          ...
          "to": [
            {
              "id": "28ceca21-3e0e-41db-b756-577e4a41b941",
      ...
      "input": [
        {
          ...
          "object": {
            "data": {
              "$op": "$and",
              "responsavelId": "output:0924e131-d535-41bf-87c7-19bbb6b8ff69:id"
            },
            ...
            "config": {
              ...
              "include": [
                {
                  "as": "assinaturaDocumentoList",
                  "required": false,
                  "tableName": "assinaturaDocumento"
                }
              ],
              "allowWhere": true,
              "allowInclude": true
      ...
      "output": [
        {
          ...
          "to": [
            {
              "id": "4c21c5de-e57a-44d5-b8e5-1c16b0616640",
      ...
      "output": [
        {
          ...
          "to": [
            {
              "id": "2cbf20c3-7a8b-4f49-a84e-b4c5f8e93c59",
