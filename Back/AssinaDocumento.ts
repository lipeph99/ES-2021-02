[
      ...
      "output": [
        {
          ...
          "to": [
            {
              "id": "4af141cc-ddb7-4c15-8c77-9fbba6fd7d4a",
      ...
      "output": [
        {
          ...
          "to": [
            {
              "id": "d29f6535-5920-4e3a-9112-1e3f047365de",
      ...
      "input": [
        {
          ...
          "object": {
            "data": {
              "id": "output:1be40c36-897a-45eb-8c39-93c68d825c53:id",
              "$op": "$and",
              "status": "0"
            },
      ...
      "output": [
        {
          ...
          "to": [
            {
              "id": "4b7a39e7-d7e1-4e48-8fbd-953ec3f9e217",
        ...
        },
        {
          ...
          "to": [
            {
              "id": "62344362-7fd9-4777-a8dc-89494ae7ebc4",
    ...
    },
    {
      ...
      "kind": 1,
      "info": {
        "title": "Update AssinaturaDocumento",
      ...
      "output": [
        {
          ...
          "to": [
            {
              "id": "51e11754-615d-4c02-9622-09723ced7c3c",
